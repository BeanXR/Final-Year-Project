...
if __name__ == '__main__':
    ...
    # Evolve hyperparameters (optional)
        ...
        meta = {'lr0': (1, 1e-5, 1e-1),  # initial learning rate (SGD=1E-2, Adam=1E-3)
                ...
                'flipud': (0, 0.0, 0),  # image flip up-down (probability) - NOTE: DONT FLIP FOR FACE TRAINING
                'fliplr': (0, 0.0, 0.0),  # image flip left-right (probability) - NOTE: DONT FLIP FOR FACE TRAINING
